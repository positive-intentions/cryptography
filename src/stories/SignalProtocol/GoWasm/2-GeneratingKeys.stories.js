      ...
      <Box sx={{ mb: 3 }}>
        <Alert severity="info" sx={{ mb: 2 }}>
          <Typography variant="body1">
            <strong>Lesson 2: Creating Your Cryptographic Identity</strong>
            <br />
            Just like you need an ID card in real life, you need cryptographic
            keys for secure messaging. Let's create your digital identity!
          </Typography>
        </Alert>

        <Alert severity="warning" sx={{ mb: 3 }}>
          <Typography variant="body2">
            <strong>Implementation Note:</strong> The Go WASM implementation has
            bugs in `generatePreKeys` and `generateSignedPreKey` functions. This
            demo shows working identity key generation and simulates the other
            keys for educational purposes. The identity keys and registration ID
            are real!
          </Typography>
        </Alert>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography variant="body2" paragraph>
              <strong>What is it?</strong> Your permanent cryptographic
              identity.
            </Typography>
            <Typography variant="body2" paragraph>
              <strong>Real-world analogy:</strong> Like your face and
              fingerprint - unique to you and doesn't change.
            </Typography>
            <CodeDisplay
...
// Returns:
{
  ...
  privateKey: "kPR5bWnXeKD8z..."   // NEVER share this!
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography variant="body2" paragraph>
              <strong>What are they?</strong> One-time keys that let people
              start conversations with you when you're offline.
            </Typography>
            <Typography variant="body2" paragraph>
              <strong>Real-world analogy:</strong> Like leaving sealed envelopes
              at a post office - each person who wants to contact you takes one
              envelope to start a secure conversation.
            </Typography>
            <CodeDisplay
...
// 3. You use preKey[42].privateKey to decrypt`}
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography variant="body2" paragraph>
              <strong>What is it?</strong> A special pre-key that includes your
              digital signature.
            </Typography>
            <Typography variant="body2" paragraph>
              <strong>Why important?</strong> Proves the pre-key really came
              from you and wasn't tampered with.
            </Typography>
            <CodeDisplay
                        ...
                        <Grid container spacing={2}>
                          <Grid item xs={12}>
                            <Paper sx={{ p: 2, bgcolor: "primary.light" }}>
                              ...
                              <CodeDisplay
                                code={
                                  keys.identity.publicKey.substring(0, 50) +
                                  "..."
                                }
                                language="text"
                                maxHeight="60px"
                          ...
                          <Grid item xs={12} md={6}>
                            <Paper sx={{ p: 2 }}>
                              ...
                              <Typography variant="caption">
                                WASM implementation has bugs - showing
                                simulation
                              </Typography>
                            </Paper>
                          </Grid>
                          ...
                          <Grid item xs={12}>
                            <Alert severity="success">
                              <Typography variant="body2">
                                <strong>Success!</strong> You've created your
                                cryptographic identity. In a real app, you'd now
                                upload your public keys to a server so others
                                can find you.
                              </Typography>
                            </Alert>
                          </Grid>
        ...
        {keys && (
          <Alert severity="info" sx={{ mt: 3 }}>
            <Typography variant="body1">
              ...
              <br />
              Now that you have your keys, the next step is to exchange them
              with someone else to establish a secure connection. Continue to
              the next lesson to learn about the X3DH key exchange! →
            </Typography>
          </Alert>
        )}
      </Box>

    ...
    try {
      ...
      setMessages([
        ...
        },
        {
          ...
          sender: "system",
          content:
            "🔑 RSA key pairs generated for message encryption (using repository crypto)",
          timestamp: new Date(),
          type: "system",
        },
      ]);
      ...
      <Box sx={{ mb: 3 }}>
        <Alert severity="info" sx={{ mb: 3 }}>
          <Typography variant="body1">
            <strong>Lesson 4: Sending Secure Messages</strong>
            <br />
            Now let's see the Double Ratchet in action! Every message gets a
            unique key, and keys automatically update after each message for
        ...
        <Alert severity="info" sx={{ mb: 3 }}>
          <Typography variant="body2">
            <strong>Hybrid Implementation:</strong> This demo combines the
            working parts of the Go WASM implementation (identity key
            generation, registration IDs, session initialization) with the
            repository's proven RSA encryption system for messaging. This
            demonstrates real cryptographic operations while working around Go
            WASM bugs in `processPreKeyBundle` and message functions.
          </Typography>
        </Alert>
        ...
        <Paper sx={{ p: 3, mb: 3 }}>
          <Typography variant="body1" paragraph>
            The Double Ratchet is like having a password that automatically
            changes after every message:
          </Typography>
            ...
            <Grid item xs={12} md={6}>
              <Card sx={{ bgcolor: "primary.light" }}>
                <CardContent>
                  ...
                  <Typography variant="body2">
                    Derives new message keys from chain keys. Each message
                    advances the chain.
                  </Typography>
                  <CodeDisplay
          ...
          <Card sx={{ mb: 3 }}>
            <CardContent>
              ...
              <Typography variant="body2" paragraph>
                Before we can send messages, we need to set up the Double
                Ratchet session between Alice and Bob. This will generate keys
                and initialize the ratchet.
              </Typography>
              <Button
                variant="contained"
                  ...
                  <Box>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      ...
                      <Chip
                        ...
                        color={
                          currentSender === "alice" ? "primary" : "secondary"
                        }
                        size="small"
                      />
                    </Typography>
                    ...
                    {cryptoKeys && (
                      <Typography variant="body2" sx={{ mt: 1 }}>
                        🔑 Using real RSA-2048 encryption with proper
              ...
              <CardContent>
                ...
                {messages.length > 0 && (
                  <Alert severity="success" sx={{ mt: 2 }}>
                    <Typography variant="body2">
                      <strong>Real Cryptography in Action!</strong>
                      <br />
                      Each message is encrypted with RSA-2048 using the
                      recipient's public key and decrypted with their private
                      key. This demonstrates proper asymmetric encryption
                      principles from Signal Protocol. Messages sent:{" "}
...
// Both sides stay synchronized!`}
            ...
            <Alert severity="info" sx={{ mt: 3 }}>
              <Typography variant="body1">
                ...
                <br />
                You've successfully implemented secure messaging with the Double
                Ratchet protocol! Each message was encrypted with a unique key
                that was immediately deleted, providing perfect forward secrecy.
                Continue to the final lesson to understand advanced concepts
                like out-of-order delivery and key rotation.
              </Typography>
            </Alert>
          </>
        )}

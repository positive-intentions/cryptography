      ...
      <Box sx={{ mb: 3 }}>
        <Alert severity="info" sx={{ mb: 3 }}>
          <Typography variant="body1">
            <strong>Lesson 3: The Secret Handshake (X3DH)</strong>
            <br />
            Learn how two people can establish a secure connection even if one
            is offline! This is the magic that lets you send messages to someone
            who hasn't opened the app yet.
          </Typography>
        </Alert>
        ...
        <Alert severity="warning" sx={{ mb: 3 }}>
          <Typography variant="body2">
            ...
            bugs in the `processPreKeyBundle` function that cause crashes. This
            demo shows working identity key generation and simulates the X3DH
            key exchange process to demonstrate the concepts without crashing.
          </Typography>
        </Alert>
        ...
        <Paper sx={{ p: 3, mb: 3 }}>
          ...
          <Typography variant="body1" paragraph>
            Imagine Alice wants to send Bob a secret message, but Bob is camping
            without internet. X3DH is like Bob leaving a secure lockbox at the
            post office that only Alice can use to start a conversation.
          </Typography>

          <Box sx={{ bgcolor: "grey.100", p: 2, borderRadius: 1, mt: 2 }}>
            <Typography variant="h6" gutterBottom>
              The Three DH in X3DH:
            </Typography>
            ...
            <Typography variant="body2">
              <strong>DH4 (optional):</strong> Alice's ephemeral key + Bob's
              one-time pre-key
            </Typography>
          </Box>
        </Paper>
  ...
  preKeys: alice.preKeys.map(k => k.public)
                        ...
                        {alice && (
                          <Alert severity="success" sx={{ mt: 2 }}>
                            ...
                            <strong>{alice.registrationId}</strong>
                          </Alert>
                        )}
                      </CardContent>
                    </Card>
  ...
  preKeys: bob.preKeys.map(k => k.public)
                        ...
                        {bob && (
                          <Alert severity="success" sx={{ mt: 2 }}>
                            ...
                            <strong>{bob.registrationId}</strong>
                          </Alert>
                        )}
                      </CardContent>
                    </Card>
                        ...
                        <Grid container spacing={2}>
                          <Grid item xs={12} md={6}>
                            <Paper sx={{ p: 2, bgcolor: "primary.light" }}>
                              ...
                              <Typography variant="body2">
                                1. Downloads Bob's bundle
                                <br />
                                2. Generates ephemeral key
                                <br />
                                3. Performs 4 DH operations
                                <br />
                          ...
                          <Grid item xs={12} md={6}>
                            <Paper sx={{ p: 2, bgcolor: "secondary.light" }}>
                              ...
                              <Typography variant="body2">
                                1. Receives first message
                                <br />
                                2. Gets Alice's ephemeral
                                <br />
                                3. Performs same 4 DH ops
                                <br />
          ...
          <>
              ...
              <Grid item xs={12} md={6}>
                <Card>
                  <CardContent>
                    ...
                    <Typography variant="body2">
                      The identity keys prove you're really talking to who you
                      think you are. The signed pre-key has Bob's signature,
                      proving it came from him.
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
                ...
                <Card>
                  <CardContent>
                    ...
                    <Typography variant="body2">
                      ...
                      Even if someone steals keys later, they can't decrypt past
                      messages.
                    </Typography>
                  </CardContent>
                </Card>
            ...
            <Alert severity="info" sx={{ mt: 3 }}>
              <Typography variant="body1">
                ...
                <br />
                Now that Alice and Bob have established a secure session, they
                can start exchanging encrypted messages. Continue to the next
                lesson to see the Double Ratchet in action! →
              </Typography>
            </Alert>
          </>
        )}

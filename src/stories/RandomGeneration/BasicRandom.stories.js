...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Generate cryptographically secure random strings using the browser's crypto.getRandomValues() API.",
      },
    },
  },
};
    ...
    >
      ...
      <Box className="demo-section" sx={{ mt: 4 }}>
        ...
        <Typography variant="body2" color="text.secondary" paragraph>
          This function uses the Web Crypto API's{" "}
          <code>crypto.getRandomValues()</code> method to generate
          cryptographically strong random values. The browser's crypto module
          seeds from the operating system's entropy pool, making it suitable for

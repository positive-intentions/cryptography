...
import { useCryptography, CryptographyProvider } from '../stories/components/Cryptography';
...
describe('Signal Protocol JavaScript Implementation (Web Crypto API Only)', () => {
    ...
    test('should perform signature operations using Ed25519', async () => {
        ...
        // Sign data
        const signature = await cryptoMethods.signSignalData(signingKeyPair.privateKey, testData);

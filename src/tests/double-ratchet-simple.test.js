...
describe('Double Ratchet - Algorithm Logic', () => {
  ...
  describe('Protocol Compliance', () => {
    test('should follow Double Ratchet specification flow', () => {
      ...
      expect(protocolSteps[protocolSteps.length - 1]).toContain('Alice derives receiving chain');
    });
  });
  ...
  describe('Fix Verification', () => {
    test('should verify the chain key synchronization fix', () => {
      ...
      const fixDescription = 'Bob uses same HKDF(root_key, CHAIN_KEY_INFO) as Alice';
    ...
    test('should document the DH ratchet step correction', () => {
      ...
      const correctedLogic = 'Bob matches Alice direct root key derivation for first receive';
      ...
      const keyInsight = 'First message uses direct root key derivation, not DH';

...
describe("Double Ratchet Fix Verification", () => {
  ...
  test("should handle the critical Alice->Bob->Alice message flow", async () => {
    ...
    console.log(
      ...
      exchangeResult.masterSecret.byteLength,
    );
    ...
    try {
      ...
      const decrypted2 = await crypto.doubleRatchetDecrypt(
        aliceState,
        encrypted2,
      );
      ...
      const decrypted3 = await crypto.doubleRatchetDecrypt(
        bobState,
        encrypted3,
      );
      ...
      console.log(
        "🎉 This confirms the JavaScript implementation handles DH ratchet correctly",
      );
  ...
  test("should verify receiving chain key establishment logic", async () => {
    ...
    console.log(
      "Alice (initiator) has sending chain key:",
      !!aliceState.sendingChainKey,
    );
    console.log(
      "Alice (initiator) has receiving chain key:",
      !!aliceState.receivingChainKey,
    );
    console.log(
      "Bob (responder) has sending chain key:",
      !!bobState.sendingChainKey,
    );
    console.log(
      "Bob (responder) has receiving chain key:",
    ...
    console.log(
      "📋 Before decryption - Bob receiving chain key:",
      !!bobState.receivingChainKey,
    );
    ...
    console.log(
      "📋 After decryption - Bob receiving chain key:",
      !!bobState.receivingChainKey,
    );
    ...
    console.log(
      "📋 Bob can now encrypt (has sending chain key):",
      !!bobState.sendingChainKey,
    );

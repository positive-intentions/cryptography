...
describe('KeyAuthentication', () => {
  ...
  describe('generateFingerprint', () => {
    ...
    test('should be deterministic', async () => {
      ...
      const fingerprint1 = await KeyAuthentication.generateFingerprint(keyBytes);
      const fingerprint2 = await KeyAuthentication.generateFingerprint(keyBytes);
    ...
    test('should produce different fingerprints for different keys', async () => {
      ...
      const fingerprint1 = await KeyAuthentication.generateFingerprint(keyBytes1);
      const fingerprint2 = await KeyAuthentication.generateFingerprint(keyBytes2);
  ...
  describe('verifyFingerprint', () => {
    test('should verify matching fingerprint', async () => {
      ...
      const isValid = await KeyAuthentication.verifyFingerprint(keyBytes, fingerprint);
    ...
    test('should reject non-matching fingerprint', async () => {
      ...
      const isValid = await KeyAuthentication.verifyFingerprint(keyBytes, wrongFingerprint);
